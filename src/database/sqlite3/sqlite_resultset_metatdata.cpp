...
int wxSqliteResultSetMetaData::GetColumnType(int i)
{
...
int wxSqliteResultSetMetaData::GetColumnSize(int WXUNUSED(i))
{
  return -1;
}

wxString wxSqliteResultSetMetaData::GetColumnName(int i)
{
  wxString columnName = ConvertFromUnicodeStream(sqlite3_column_name(m_pSqliteStatement, i-1));
  return columnName;
}

int wxSqliteResultSetMetaData::GetColumnCount()
{
